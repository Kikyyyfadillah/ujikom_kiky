                ...
                <div class="col-md-12 col-sm-3 bg-white">
                    <div class="x_title">
                        ...
                        <div class="float-right ml-auto">
                            ...
                            <a class="btn btn-success" href="{{route('export-kategori')}}" class="btn btn-success"><i class=" fa fa-file-excel-o"></i>Export</a>
                            <a class="btn btn-danger" href="{{route('export-kategori.pdf')}}" class="btn btn-danger"><i class=" fa fa-file-pdf-o"></i>Export PDF</a>
